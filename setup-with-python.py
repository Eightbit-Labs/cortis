...
with open(r'.husky\post-commit', 'w', encoding='utf-8') as f:
    f.write(post_commit)

print('✅ Created .husky/post-commit')

# Create scripts/check-secrets.js
secrets = r'''#!/usr/bin/env node
/**
 * check-secrets.js
...
with open(r'scripts\check-secrets.js', 'w', encoding='utf-8') as f:
    f.write(secrets)

print('✅ Created scripts/check-secrets.js')
